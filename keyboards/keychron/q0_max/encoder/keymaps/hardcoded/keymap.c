...
# endif
    ...
    [FN] = LAYOUT_tenkey_27(
        ...
        SE_LOCK, UG_NEXT, UG_VALU, UG_HUEU, CG(KC_Q),
        XXXXXXX, UG_PREV, UG_VALD, UG_HUED, QX_MOD,
        XXXXXXX, UG_SATU, UG_SPDU, KC_MPRV,
        XXXXXXX, UG_SATD, UG_SPDD, KC_MPLY, QX_BOOT,
        XXXXXXX, UG_TOGG,          KC_MNXT          )
};
...
#ifdef Q0_MAX_EXTENDED_LAYERS
# ifdef Q0_MAX_EXTENDED_LAYERS_X1
    [X1]   = {ENCODER_CCW_CW(UG_VALD, UG_VALU)},
# endif

# ifdef Q0_MAX_EXTENDED_LAYERS_X2
    [X2]   = {ENCODER_CCW_CW(UG_VALD, UG_VALU)},
# endif

# ifdef Q0_MAX_EXTENDED_LAYERS_X3
    [X3]   = {ENCODER_CCW_CW(UG_VALD, UG_VALU)},
# endif

# ifdef Q0_MAX_EXTENDED_LAYERS_X4
    [X4]   = {ENCODER_CCW_CW(UG_VALD, UG_VALU)},
# endif
#endif
